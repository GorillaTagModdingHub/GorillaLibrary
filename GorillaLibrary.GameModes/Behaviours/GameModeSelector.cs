...
namespace GorillaLibrary.GameModes.Behaviours
{
    ...
    internal class GameModeSelector : MonoBehaviour
    {
        ...
        public List<Gamemode> GetSelectorGameModes()
        {
            ...
            GameModeType[] modesForZone = Layout is CustomMapModeSelector ? [.. (List<GameModeType>)AccessTools.Field(typeof(CustomMapModeSelector), "gamemodes").GetValue(null)] : [.. GameMode.GameModeZoneMapping.GetModesForZone(Zone, NetworkSystem.Instance.SessionIsPrivate)];
