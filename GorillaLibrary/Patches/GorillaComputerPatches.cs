...
namespace GorillaLibrary.Patches
{
    ...
    internal static class GorillaComputerPatches
    {
        ...
        [HarmonyPatch("UpdateGameModeText"), HarmonyPrefix]
        public static bool UpdateModeTextPatch(GorillaComputer __instance)
        {
            ...
            Models.GameModeWrapper gamemode = GameModeUtility.CurrentGameMode;
            currentGameModeText.Value = $"{currentMode}\n{(gamemode is not null ? gamemode.DisplayName.ToUpper() : "ERROR")}";
        ...
        internal static bool InitializeModePatch(GorillaComputer __instance, ref bool ___didInitializeGameMode)
        {
